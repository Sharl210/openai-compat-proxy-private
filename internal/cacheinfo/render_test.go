		...
		},
		{
			...
			stats: ProviderStats{
				...
				RecentDays: []DailyStats{{
					Date:   "2026-03-27",
					Totals: TokenTotals{InputTokens: 100, CachedTokens: 25, OutputTokens: 40, TotalTokens: 140, RequestCount: 3},
				}},
				HistoryTotal: TokenTotals{InputTokens: 100, CachedTokens: 25, OutputTokens: 40, TotalTokens: 140, RequestCount: 3},
				UpdatedAt:    now,
			},
			contains: []string{
				"总调用次数：3",
