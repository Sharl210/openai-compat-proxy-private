...
func TestUpstreamTransportPool_hot_reload_prunes_deleted_provider(t *testing.T) {
...
func TestUpstreamTransportPool_hot_reload_prunes_renamed_provider(t *testing.T) {
	upstreamServer, connectionClosed := newReconcileTestServer(t, nil)
	fixture := newReconcileRuntimeFixture(t, upstreamServer.URL)
	fixture.requestModels(t, "/provider-a/v1/models")
...
func TestUpstreamTransportPool_hot_reload_prunes_disabled_provider(t *testing.T) {
	upstreamServer, connectionClosed := newReconcileTestServer(t, nil)
	fixture := newReconcileRuntimeFixture(t, upstreamServer.URL)
	fixture.requestModels(t, "/provider-a/v1/models")
...
func TestUpstreamTransportPool_stale_snapshot_cannot_restore_removed_provider(t *testing.T) {
...
func TestUpstreamTransportPool_retired_active_SSE_receives_terminal_then_connection_closes(t *testing.T) {
...
func awaitConnectionClosed(t *testing.T, closed <-chan struct{}) {
	t.Helper()
	awaitSignal(t, closed, "upstream TCP StateClosed")
}
