...
func TestTransportPool_Reconcile_absent_provider_generations_retired(t *testing.T) {
...
func TestTransportPool_Reconcile_present_provider_preserved(t *testing.T) {
	pool := NewTransportPool()
...
func TestTransportPool_Reconcile_duplicate_call_is_idempotent(t *testing.T) {
	pool := NewTransportPool()
...
func TestTransportPool_Reconcile_retires_outside_pool_lock(t *testing.T) {
	pool := NewTransportPool()
...
func TestTransportPool_reuses_normalized_equivalent_key(t *testing.T) {
	pool := NewTransportPool()
...
func TestTransportPool_separates_transport_key_fields(t *testing.T) {
...
func TestTransportPool_promotes_hit_before_eviction(t *testing.T) {
	pool := NewTransportPool()
...
func TestTransportPool_does_not_retain_provider_removed_by_reconcile(t *testing.T) {
	pool := NewTransportPool()
	cfg := transportPoolTestConfig()
	pool.ReconcileProviderIDs([]string{"provider-a"})
